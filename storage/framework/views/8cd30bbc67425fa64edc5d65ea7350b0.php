                        ...
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if(isset($estimate)): ?>
                                    <?php if($currency->id == $estimate->currency_id): echo 'selected'; endif; ?>
                                <?php elseif(isset($invoice)): ?>
                                    <?php if($currency->id == $invoice->currency_id): echo 'selected'; endif; ?>
                                <?php else: ?>
                                    <?php if($currency->id == company()->currency_id): echo 'selected'; endif; ?>
                                <?php endif; ?>
...
<?php endif; ?>
                ...
                class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15" value="<?php echo e(isset($estimateCurrency) ? $estimateCurrency?->exchange_rate : (isset($proposalCurrency) ? $proposalCurrency?->exchange_rate : $companyCurrency->exchange_rate)); ?>" readonly>
                            ...
                            <select class="form-control select-picker" data-live-search="true" data-size="8"
                                ...
                                <?php if(isset($invoice) && $invoice->client): ?>
                                    <?php $__currentLoopData = $invoice->client->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($invoice->project_id == $item->id): echo 'selected'; endif; ?>  value="<?php echo e($item->id); ?>"
                        ...
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            <option value="">--</option>
                                <?php $__currentLoopData = $invoicePayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoicePayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($invoicePayment->id); ?>">
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php if($addProductPermission == 'all' || $addProductPermission == 'added'): ?>
                            <?php if(module_enabled('Purchase') && in_array('purchase', user_modules())): ?>
                                                ...
                                                <select id="multiselect" name="taxes[<?php echo e($key); ?>][]"
                                                    ...
                                                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option data-rate="<?php echo e($tax->rate_percent); ?>" data-tax-text="<?php echo e($tax->tax_name .':'. $tax->rate_percent); ?>%"
                                                            <?php if(isset($item->taxes) && array_search($tax->id, json_decode($item->taxes)) !== false): echo 'selected'; endif; ?> value="<?php echo e($tax->id); ?>">
                                    ...
                                    <tr class="d-none d-md-block d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            <input type="file" class="dropify itemImage"
                                                ...
                                                data-item-id="image<?php echo e($item->id); ?>"
                                        ...
                                        <td class="border-left-0">
                                            <?php if(isset($type) && $type == 'proposal'): ?>
                                                <input type="hidden" id="imageId_<?php echo e($item->id); ?>"
                                                    ...
                                                    value=<?php echo e(isset($item->proposalItemImage->id) ? $item->proposalItemImage->id : ''); ?> />
                                                ...
                                                <input type="file" class="dropify itemImage"
                                                    ...
                                                    data-default-file="<?php echo e($item->proposalItemImage ? $item->proposalItemImage->file_url : ''); ?>"
                                                    data-height="70" multiple />
                                                <input type="hidden" name="invoice_item_image_url[]"  value="<?php echo e($item->proposalItemImage ? $item->proposalItemImage->file : ''); ?>">
                                            <?php else: ?>
                                                <input type="hidden" id="imageId_<?php echo e($item->id); ?>"
                                                    class="itemOldImage" name="image_id[]"
                                                    ...
                                                    <tr>
                                                        <td width="70%" class="c-inv-sub-padding">
                                                            <input type="number" min="0" name="discount_value"
                                                                ...
                                                                placeholder="0"
                                                                value= "<?php echo e(isset($estimate) ? $estimate->discount : (isset($invoice) ? $invoice->discount : '0')); ?>">
                                                        </td>
                                                        <td width="30%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option  <?php if(isset($invoice) && $invoice->discount_type == 'percent'): echo 'selected'; endif; ?> value="percent">%
                                                                    </option>
                                                                    <option <?php if(isset($invoice) && $invoice->discount_type == 'fixed'): echo 'selected'; endif; ?> value="fixed">
...
<?php endif; ?>
                <textarea class="form-control" name="note" id="note" rows="4"
                    placeholder="<?php echo app('translator')->get('placeholders.invoices.note'); ?>"><?php echo e(isset($estimate) ? $estimate->note : (isset($invoice) ? $invoice->note : '')); ?></textarea>
            </div>
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldId' => 'payment_status','fieldLabel' => __('modules.invoices.receivedPayment'),'fieldValue' => '0','fieldName' => 'payment_status'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="col-md-3 d-none" id="add_offline">
                <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'add_offline_methods','fieldLabel' => __('modules.payments.offlinePaymentMethod'),'fieldName' => 'offline_methods','search' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<script>
    ...
    $(document).ready(function() {
                    ...
                    if (response.status == 'success') {
                        if (response.data !== null) {
                            ...
                            if (response.data.client_details.shipping_address === null) {
                                var addShippingLink =
                                    '<a href="javascript:;" class="" id="show-shipping-field"><i class="f-12 mr-2 fa fa-plus"></i><?php echo app('translator')->get("app.addShippingAddress"); ?></a>';
        ...
        $(document).on('click', '#add-item', function() {
            ...
            item += `<td class="border-bottom-0">
                ...
                <select class="text-dark-grey float-right border-0 f-12" name="unit_id[]">
                    <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($unit->default == 1): echo 'selected'; endif; ?> value="<?php echo e($unit->id); ?>"><?php echo e($unit->unit_type); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <input type="hidden" name="product_id[]" value="">
                </td>
    ...
    $('#payment_gateway_id').on('change', function(){
        ...
        if (val == 'Offline'){
            let url = "<?php echo e(route('offline.methods')); ?>";
...
<?php endif; ?>
<?php /**PATH /home/u594498081/domains/crm.rrpateloverseas.com/public_html/resources/views/invoices/ajax/create.blade.php ENDPATH**/ ?>