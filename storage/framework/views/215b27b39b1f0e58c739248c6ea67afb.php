...
<?php $component->withAttributes([]); ?>
                            ...
                            <option value="digitalocean"
                                    data-content="<img src='<?php echo e(asset('img/digitalocean.svg')); ?>' width='20' height='20' /> <?php echo app('translator')->get('app.storageSetting.digitalocean'); ?>"
                                    <?php if(isset($digitalOceanCredentials) && $digitalOceanCredentials->status == 'enabled'): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('app.storageSetting.digitalocean'); ?>
                            </option>
                            <option value="aws_s3"
                                    data-content="<img src='<?php echo e(asset('img/aws_s3.svg')); ?>' width='20' height='20' /> <?php echo app('translator')->get('app.storageSetting.aws_s3'); ?>"
                                    <?php if(isset($awsCredentials) && $awsCredentials->status == 'enabled'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.storageSetting.aws_s3'); ?>
                            </option>
                            <option value="wasabi"
                                    data-content="<img src='<?php echo e(asset('img/wasabi.svg')); ?>' width='20' height='20' /> <?php echo app('translator')->get('app.storageSetting.wasabi'); ?>"
                                    <?php if(isset($wasabiCredentials) && $wasabiCredentials->status == 'enabled'): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('app.storageSetting.wasabi'); ?>
                            </option>
                            <option value="minio"
                                    data-content="<img src='<?php echo e(asset('img/minio.svg')); ?>' width='20' height='10px' /> <?php echo app('translator')->get('app.storageSetting.minio'); ?>"
                                    <?php if(isset($minioCredentials) && $minioCredentials->status == 'enabled'): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('app.storageSetting.minio'); ?>
                            </option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php echo $__env->make('storage-settings.minio', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'test-aws','class' => 'minio-form mr-3']); ?>
                            <?php echo app('translator')->get('app.storageSetting.testMinio'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'local-to-aws','class' => 'move-form']); ?>
                                <?php echo app('translator')->get('app.moveFilesToCloud'); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u594498081/domains/crm.rrpateloverseas.com/public_html/resources/views/storage-settings/index.blade.php ENDPATH**/ ?>